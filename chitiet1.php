...
<img class="demo cursor" src="upload/<?php echo $row['img4'] ?>" style="width:100%;height: 80px;" onclick="currentSlide(4)" alt="Mountains and fjords">
                                ...
                                <div class="col l-7">
                                    <div class="content-product__right">
                                        <span class="content-product__right-money"><?php echo $row["tensp"] ?></span>
                                        <div class="content-product__right-code">
                                            <span class="content-product__code-letter">Đơn giá:</span>
                                            <span class="content-product__code-num"><?php echo $row["dongiamoi"] ?> 000 VNĐ</span>
                                        </div>
