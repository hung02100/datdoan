        ...
        <div class="news__detail-post">
            <a href="chitiettintuc.php?masp=<?php echo $row["masp"] ?>">
                ...
                <div class="news__detail-info">
                    <a href="chitiettintuc.php?masp=<?php echo $row["masp"] ?>"
                        class="news__detail-title"><?php echo $row["tensp"] ?></h2>
                        <span class="news__detail-per">
                            <p>
                        ...
                        <p class="news__details-msg"><?php echo $row["mota"] ?>Bạn cho giá thể đã xử lý nấm bệnh vào chậu
                            cao cách miệng 5cm. Trồng cây sao cho cây phân bố xung quanh chậu, không trồng cây quá sát thành
                            chậu. Nên trồng cây vào buổi chiều, sau khi tưới nước đẫm cây.</p>
                </div>
            </a>
        </div>
